...
Future<BitmapDescriptor> getNetworkImageMarker() async {
  ...
  final Uint8List markerIcon =
      await _getBytesFromAsset(100, webData: resp.data);
  return BitmapDescriptor.fromBytes(markerIcon);
}

Future<Uint8List> _getBytesFromAsset(int width,
    {ByteData? data, Uint8List? webData}) async {
  ui.Codec codec = await ui.instantiateImageCodec(
      data != null ? data.buffer.asUint8List() : webData!,
      targetWidth: width);
