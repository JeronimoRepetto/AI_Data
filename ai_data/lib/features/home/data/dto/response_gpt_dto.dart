...
class ResponseGptDTO {
  ...
  factory ResponseGptDTO.fromJson(String str) =>
      ResponseGptDTO.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory ResponseGptDTO.fromMap(Map<String, dynamic> json) => ResponseGptDTO(
        id: json["id"],
        object: json["object"],
